...
import ToWatchService from './modules/to-watch/to-watch.service.js';
import CommentService from './modules/comment/comment.service.js';
import { UserEntity, UserModel } from './modules/user/user.entity.js';
import { MovieEntity, MovieModel } from './modules/movie/movie.entity.js';
import { ToWatchEntity, ToWatchModel } from './modules/to-watch/to-watch.entity.js';
...
import { ToWatchServiceInterface } from './modules/to-watch/to-watch-service.interface.js';
...
applicationContainer.bind<ToWatchServiceInterface>(Component.ToWatchServiceInterface).to(ToWatchService);
...
applicationContainer.bind<types.ModelType<ToWatchEntity>>(Component.ToWatchModel).toConstantValue(ToWatchModel);
